...
所以演示里那三个"已经开业、按价目表收费"的档位（华东·收费 / 华北·免费 /
新加坡·x402）**不能再靠卡上写一行 `x-a2n.trial=false` 一上来就可收费**了 ——
它们必须真的走完免费期。
...
ESTABLISHED = ("华东-精算OCR", "华北-公益OCR", "新加坡-极速OCR")
